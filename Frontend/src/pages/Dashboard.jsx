    ...
    return (
      <div className="min-h-screen bg-stone-100 p-4 md:p-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <div className="h-10 w-48 bg-gray-300 border-4 border-black animate-pulse transform -rotate-1" />
            <div className="h-4 w-40 bg-gray-200 border-2 border-black animate-pulse mt-3" />
          </div>
          <div className="flex items-center gap-4">
            <div className="h-10 w-28 bg-gray-300 border-4 border-black animate-pulse" />
            <div className="w-12 h-12 bg-gray-300 border-4 border-black rounded-full animate-pulse" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          {[1,2,3,4,5].map(i => (
            <div key={i} className="bg-white border-4 border-black p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <div className="h-3 w-20 bg-gray-300 border-2 border-black animate-pulse mb-2" />
              <div className="h-7 w-24 bg-gray-300 border-2 border-black animate-pulse" />
            </div>
          ))}
        </div>

        <div className="flex gap-2 mb-6 border-b-4 border-black pb-4">
          {[1,2,3].map(i => (
            <div key={i} className="h-10 w-24 bg-gray-300 border-4 border-black animate-pulse" />
          ))}
        </div>

        <div className="bg-white border-8 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
          <div className="bg-yellow-400 border-b-4 border-black p-4">
            <div className="h-6 w-36 bg-gray-300 border-2 border-black animate-pulse" />
          </div>
          <div className="hidden md:block">
            <div className="bg-black p-4 flex gap-4">
              {[1,2,3,4,5,6].map(i => (
                <div key={i} className="h-4 bg-gray-600 animate-pulse flex-1" />
              ))}
            </div>
            {[1,2,3].map(i => (
              <div key={i} className={`border-t-4 border-black p-4 flex gap-4 ${i % 2 === 0 ? 'bg-stone-50' : 'bg-white'}`}>
                <div className="h-4 bg-gray-300 border-2 border-black animate-pulse flex-1" />
                <div className="h-4 bg-gray-300 border-2 border-black animate-pulse flex-1" />
                <div className="h-4 bg-gray-300 border-2 border-black animate-pulse flex-1" />
                <div className="h-4 bg-gray-300 border-2 border-black animate-pulse flex-1" />
                <div className="h-6 w-20 bg-gray-300 border-2 border-black animate-pulse" />
                <div className="h-6 w-14 bg-gray-300 border-2 border-black animate-pulse" />
              </div>
            ))}
          </div>
          <div className="md:hidden">
            {[1,2,3].map(i => (
              <div key={i} className="border-t-4 border-black p-4 bg-white">
                <div className="flex justify-between items-start mb-2">
                  <div className="flex-1">
                    <div className="h-5 w-28 bg-gray-300 border-2 border-black animate-pulse mb-2" />
                    <div className="h-3 w-36 bg-gray-200 animate-pulse" />
                  </div>
                  <div className="h-6 w-16 bg-gray-300 border-2 border-black animate-pulse" />
                </div>
                <div className="flex justify-between items-center mt-3">
                  <div className="h-7 w-20 bg-gray-300 border-2 border-black animate-pulse" />
                  <div className="h-8 w-16 bg-gray-300 border-2 border-black animate-pulse" />
                </div>
              </div>
            ))}
          </div>
          <div className="border-t-4 border-black p-4 bg-stone-50">
            <div className="h-4 w-32 bg-gray-300 border-2 border-black animate-pulse mx-auto" />
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[1,2,3].map(i => (
            <div key={i} className="bg-white border-4 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <div className="h-8 w-8 bg-gray-300 border-2 border-black animate-pulse mb-2" />
              <div className="h-4 w-32 bg-gray-300 border-2 border-black animate-pulse" />
            </div>
          ))}
        </div>
      </div>
